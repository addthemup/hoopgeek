...
def main():
    ...
    print("2. Import player info (comprehensive player data)")
    print("3. Import career stats")
    print("4. Import 2024-25 games")
    print("5. Import player game logs")
    print("6. Import 2025-26 season")
    print("7. Import ESPN projections")
    print("8. Import HoopsHype salaries")
    print("=" * 60)
