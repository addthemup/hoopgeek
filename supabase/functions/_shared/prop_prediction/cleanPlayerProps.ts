...
export interface CleanedPlayerProp {
  ...
  /** Preserved from raw prop for team confidence: game home/away tricodes. */
  player_props_games?: { home_team_tricode?: string; away_team_tricode?: string; id?: string; nba_game_id?: string; game_date?: string } | { home_team_tricode?: string; away_team_tricode?: string }[];
}
  ...
  propGroups.forEach((group) => {
    ...
    if (!primaryRaw) {
      ...
      const cleanedProp: CleanedPlayerProp = {
        ...
        player_props_games: base.player_props_games,
      };
