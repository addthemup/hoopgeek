...
-- This migration updates the existing RLS policies to properly allow commissioners to create leagues
...
-- Create new, more specific policies for leagues
...
-- Create new, more specific policies for league_settings
...
-- Create new, more specific policies for teams
...
-- Create new, more specific policies for draft_order
...
-- Create new, more specific policies for league_states
...
-- Create new, more specific policies for league_invitations
...
-- Create new, more specific policies for league_members
