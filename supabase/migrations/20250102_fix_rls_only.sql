...
-- This migration only updates the RLS policies without creating tables
...
-- Create specific policies for leagues
...
-- Create specific policies for league_settings
...
-- Create specific policies for teams
...
-- Create specific policies for draft_order
...
-- Create specific policies for league_states
...
-- Create specific policies for league_invitations
...
-- Create specific policies for league_members
