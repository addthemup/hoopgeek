-- ============================================================================
-- Add Icon Parameters to DFS Pool Creation
-- ============================================================================
-- This migration:
-- 1. Updates create_dfs_pool_from_games to accept icon parameters
-- 2. Updates dfs_todays_contests view to include icon fields
-- ============================================================================
...
-- Recreate function with icon parameters
...
BEGIN
  ...
  -- Create the pool with explicit ENUM casts and icon fields
...
-- Update dfs_todays_contests view to include icon fields
-- Drop the view first to avoid column position conflicts
DROP VIEW IF EXISTS dfs_todays_contests CASCADE;

CREATE VIEW dfs_todays_contests AS
SELECT 
  p.id as pool_id,
  p.name,
  p.description,
