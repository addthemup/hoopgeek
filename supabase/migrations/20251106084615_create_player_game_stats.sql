...
DROP POLICY IF EXISTS "Anyone can read player game stats" ON public.nba_player_game_stats;
...
DROP POLICY IF EXISTS "Anyone can read league averages" ON public.nba_league_averages;
...
DROP POLICY IF EXISTS "Service role can modify player game stats" ON public.nba_player_game_stats;
CREATE POLICY "Service role can modify player game stats"
    ON public.nba_player_game_stats
    FOR ALL
    USING (auth.role() = 'service_role');

DROP POLICY IF EXISTS "Service role can modify league averages" ON public.nba_league_averages;
