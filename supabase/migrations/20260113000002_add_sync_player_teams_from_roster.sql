-- =====================================================
-- FUNCTION: Sync player team info from nba_team_roster to nba_players
-- =====================================================
...
-- Add comment
COMMENT ON FUNCTION sync_player_teams_from_roster IS 'Syncs player team information from nba_team_roster to nba_players. Use this to fix team assignments after running import_players_robust.';
