-- =====================================================
-- FIX PICK TRADING IN ACCEPT_TRADE_OFFER
-- =====================================================
-- This script fixes the accept_trade_offer function to properly
-- handle pick trading when current_team_id is NULL (original picks)
-- =====================================================

-- Drop existing function
DROP FUNCTION IF EXISTS accept_trade_offer(UUID, UUID, BOOLEAN);

-- Recreate with fix for pick trading
...
DO $$
BEGIN
    RAISE NOTICE '✅ Fixed accept_trade_offer function to handle pick trading properly';
