-- =====================================================
-- FIX: Drop Player Should NOT Delete Roster Spots
-- =====================================================
-- CRITICAL BUG FIX: When dropping a player, we should clear
-- the player_id from the roster spot, NOT delete the roster spot.
...
BEGIN
    ...
    -- ⚠️ CRITICAL FIX: Clear the player from roster spot, DON'T DELETE the spot
    -- Roster spots are permanent and should never be deleted
...
DO $$
BEGIN
    RAISE NOTICE '✅ drop_player function fixed - roster spots are now preserved!';
    RAISE NOTICE '📋 Changes: UPDATE roster spot instead of DELETE';
    RAISE NOTICE '⚠️  Run this in Supabase SQL Editor immediately!';
END $$;
